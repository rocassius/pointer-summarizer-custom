...
class Batch(object):
  ...
  def store_orig_strings(self, example_list):
    self.original_s = [ex.original_article for ex in example_list] # list of lists
...
class Batcher(object):
  ...
  def text_generator(self, example_generator):
    while True:
      ...
      try:
        # article_text = e.features.=['article'].bytes_list.value[0] # the article text was saved under the key 'article' in the data files
        # abstract_text = e.featuresabstract'].bytes_list.value[0] # the abstract text was saved under the key 'abstract' in the data files
